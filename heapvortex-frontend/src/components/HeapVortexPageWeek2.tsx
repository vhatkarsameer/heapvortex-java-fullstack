...
import { HeapVortexVisualizer } from "./HeapVortexVisualizer";
import { HeapObjectDetailsPanel } from "./HeapObjectDetailsPanel";
import HeapMetrics from "./HeapMetrics";
import { trpc } from "@/lib/trpc";

const Spinner = () => <div className="animate-spin h-5 w-5 border-2 border-indigo-500 rounded-full border-t-transparent" />;
