...
When launching the backend Spring Boot app, provide these VM options to enable SSL JMX communication and open reflective module access for Eclipse MAT dependencies:
