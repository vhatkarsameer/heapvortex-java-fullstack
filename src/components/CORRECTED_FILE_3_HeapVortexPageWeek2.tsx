...
export default function HeapVortexPageWeek2() {
  ...
  // Fetch heap objects with proper interface
  ...
  const handleExportData = () => {
    const data = {
      ...
      objects: objects.map((obj) => ({
        ...
        address: obj.address,
        shallowHeap: obj.shallowHeap,
        retainedHeap: obj.retainedHeap,
      })),
                ...
                {objects.slice(0, 15).map((obj) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      Retained: {(obj.retainedHeap / 1024).toFixed(2)} KB
                    </p>
                    <p className="text-xs text-gray-500">
                      Shallow: {(obj.shallowHeap / 1024).toFixed(2)} KB
                    </p>
                  </div>
                ))}
                {objects.length > 15 && (
          ...
          {selectedObject && (
            <div className="p-4 bg-purple-900 bg-opacity-30 border-t border-purple-700">
              ...
              <p className="text-xs text-gray-400">
                Retained: {(selectedObject.retainedHeap / 1024).toFixed(2)} KB
              </p>
            </div>
          )}
        </div>
